...
<head>
    <meta charset="UTF-8">
    <title>Modifier un Élément Pédagogique</title>
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resources/css/bootstrap.min.css">
</head>
<body>
    <div class="container">
        <h1>Modifier un Élément Pédagogique</h1>
        <form:form modelAttribute="elementPedagogiqueForm" method="post" action="${pageContext.request.contextPath}/elements-pedagogiques/${elementPedagogiqueForm.id}/modifier">
