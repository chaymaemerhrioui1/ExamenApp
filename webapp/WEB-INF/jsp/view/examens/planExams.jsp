            ...
            <tbody>
                <c:forEach var="examen" items="${examens}">
                    <tr>
                        ...
                        <td>${examen.epreuveFilePath}</td>
                        <td>${examen.pvFilePath}</td>
                        ...
                        <td>
                            <a href="${pageContext.request.contextPath}/examens/modifier/${examen.id}" class="btn btn-warning btn-sm">Modifier</a>
