...
public class PersonneMngController {
	...
	public String processCreateGroup(@ModelAttribute("groupForm") GroupForm groupForm, BindingResult bindingResult) {
		...
		Filiere filiere = filiereRepository.findById(groupForm.getFiliereId()).orElse(null);
		Departement departement = departementRepository.findById(groupForm.getDepartementId()).orElse(null);
		...
		newGroup.setEnseignants(selectedEnseignants);

		String enseignantsIds = groupForm.getEnseignantsIds().stream()
				.map(String::valueOf)
				.collect(Collectors.joining(","));
		newGroup.setEnseignantsIds(enseignantsIds);
