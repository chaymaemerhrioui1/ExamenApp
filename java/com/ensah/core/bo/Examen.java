...
public class Examen {
    ...
    private String epreuveFilePath;
    ...
    public String getEpreuveFilePath() {
        return epreuveFilePath;
    }

    public void setEpreuveFilePath(String epreuveFilePath) {
        this.epreuveFilePath = epreuveFilePath;
    }

    public String getPvFilePath() {
        return pvFilePath;
    }

    public void setPvFilePath(String pvFilePath) {
